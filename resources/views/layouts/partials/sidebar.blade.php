            ...
            <ul id="side-menu">
                    <li>
                        <a class="waves-effect" href="{{url('dashboard')}}" aria-expanded="false">
                            ...
                            <img src="{{asset('website')}}/images/dashboard.png" alt="">
                ...
                @if(auth()->user()->isAdmin() == true)
                    ...
                    <li>
                        <a class="waves-effect" href="javascript:void(0);" aria-expanded="false"><img src="{{asset('website')}}/images/user.png" alt="">
                        <span class="hide-menu">Manage User</span></a>
                        <ul aria-expanded="false" class="collapse extra">

                            <li>
                                <a href="{{asset('emailUser/email-user')}}" aria-expanded="false">
                                <img src="{{asset('website')}}/images/user.png" alt="">
                                <span class="hide-menu">Users</span></a>
                            </li>
                            <li>
                                <a href="{{asset('group/group')}}" aria-expanded="false">
                                <img src="{{asset('website')}}/images/groups.png" alt="">
                ...
                <li>
                    ...
                    <img src="{{asset('website')}}/images/email.png" alt="">
                    <span class="hide-menu">Email</span></a>
                    <ul aria-expanded="false" class="collapse extra">
                         <li>
                            <a href="{{asset('inbox/inbox')}}" aria-expanded="false">
                            <img src="{{asset('website')}}/images/inbox.png" alt="">
                                <span class="hide-menu">Inbox</span></a>
                        </li>
                        <li>
                            <a href="{{asset('sentEmail/sent-email/create')}}" aria-expanded="false">
                            <img src="{{asset('website')}}/images/send_email.png" alt="">
                                <span class="hide-menu">Send Email</span></a>
                        </li>
                        <li>
                            <a href="{{asset('sentGroupEmail/sent-group-email/create')}}" aria-expanded="false">
                            <img src="{{asset('website')}}/images/send_email.png" alt="">
                                <span class="hide-menu">Send Group Email</span></a>
                        </li>
                        <li>
                            <a href="{{asset('sentEmail/sent-email')}}" aria-expanded="false">
                            <img src="{{asset('website')}}/images/sent.png" alt="">
                                <span class="hide-menu">Sent</span></a>
                        </li>
                        
                       {{-- <li>
                            <a href="{{asset('sentGroupEmail/sent-group-email')}}" aria-expanded="false">
                            <img src="{{asset('website')}}/images/inbox.png" alt="">
                                <span class="hide-menu">Group Email List</span></a>
                        </li>--}}
                    </ul>
                </li>
                <li>
                    <a class="waves-effect" href="{{asset('email_logs')}}">
                        <img src="{{asset('website')}}/images/email.png" alt="">
                    ...
                    <li>
                        <a class="waves-effect" href="javascript:void(0);" aria-expanded="false">
                            <img src="{{asset('website')}}/images/campaign.png" alt="">
                            <span class="hide-menu">Campaign</span></a>
                        <ul aria-expanded="false" class="collapse extra">
                            <li>
                                <a href="{{asset('campaign/campaign')}}" aria-expanded="false">
                                    <img src="{{asset('website')}}/images/campaign.png" alt="">
                                    <span class="hide-menu">All Campaign</span></a>
                            </li>
                            <li>
                                <a href="{{asset('/campaign_logs')}}" aria-expanded="false">
                                    <img src="{{asset('website')}}/images/campaign.png" alt="">
                    ...
                    @foreach($laravelAdminMenus->menus as $section)
                        @if(count(collect($section->items)) > 0)
                            @foreach($section->items as $menu)
                                ...
                                @continue
                                @endif
                                @if($menu->title =='SentEmail')
                                @continue
                                @endif
                                @if($menu->title =='SentGroupEmail')
                                @continue
                                @endif
                ...
                <!-- <li>
                    <a class="waves-effect" href="{{ route('manage_users') }}">
                        <i class="fa fa-gear fa-fw"></i>
                        <span class="hide-menu">Manage Users</span>
                    </a>
                </li>
                <li>
                    <a class="waves-effect" href="{{ route('groups') }}">
                        <i class="fa fa-gear fa-fw"></i>
              ...
              {{--  <li>
                    ...
                    <ul aria-expanded="false" class="collapse extra">
                        ...
                        <li>
                            <a href="{{asset('manage_users')}}" aria-expanded="false">
                            <img src="{{asset('website')}}/images/user.png" alt="">
                            <span class="hide-menu">Users</span></a>
                        </li>
                        <li>
                            <a href="{{asset('groups')}}" aria-expanded="false">
                            <img src="{{asset('website')}}/images/groups.png" alt="">
                            <span class="hide-menu">Groups</span></a>
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse extra">
                        ...
                        <li>
                            <a href="{{asset('send_email')}}" aria-expanded="false">
                            <img src="{{asset('website')}}/images/send_email.png" alt="">
                                <span class="hide-menu">Send Email</span></a>
                        </li>
                        <li>
                            <a href="{{asset('mail_inbox')}}" aria-expanded="false">
                            <img src="{{asset('website')}}/images/inbox.png" alt="">
                                <span class="hide-menu">Inbox</span></a>
                        </li>
                        <li>
                            <a href="{{asset('mail_sent')}}" aria-expanded="false">
                            <img src="{{asset('website')}}/images/sent.png" alt="">
                                <span class="hide-menu">Sent</span></a>
                        </li>
                    </ul>
                ...
                <li>
                    <a class="waves-effect" href="javascript:void(0);" aria-expanded="false">
                        <img src="{{asset('website')}}/images/campaign.png" alt=""> 
                        <span class="hide-menu">Campaigns</span></a>
                    <ul aria-expanded="false" class="collapse extra">
                        
                        <li>
                            <a href="{{asset('all_campaigns')}}" aria-expanded="false">
                            <img src="{{asset('website')}}/images/campaign.png" alt="">
                                <span class="hide-menu">All Campaign</span></a>
                        </li>
                        <li>
                ...
                <li>
                    <a class="waves-effect" href="{{ url('email_logs') }}">
                        <!-- <i class="fa fa-gear fa-fw"></i> -->
                        <img src="{{asset('website')}}/images/email.png" alt="">
                        <span class="hide-menu">Email Logs</span>
                    </a>
                ...
                <li>
                    <a class="waves-effect" href="{{url('logout')}}">
                        <img src="{{asset('website')}}/images/logout.png" alt="">
