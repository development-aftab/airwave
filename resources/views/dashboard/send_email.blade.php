                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="txt_field_white">
                                    <label>Send To</label>
                                    <select class="select2 m-b-10 select2-multiple" name="send_to" multiple="multiple"
                                        data-placeholder="Email Here">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="txt_field_white">
                                    <label>Sent to Group</label>
                                    <select class="select2 m-b-10 select2-multiple" name="send_to_group"
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="inner_section_submit_btn">
                                    ...
                                    <input class="btn btn_primary" type="submit" value="Sent">
                                </div>
                            </div>
                        </div>
                    </form>
