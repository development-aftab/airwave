        ...
        <div class="col-md-4">
            <div class="white-box chat-widget">
                ...
                <ul class="chat-list slimscroll" style="overflow: hidden;" tabindex="5005">
                    <li>
                        <div class="chat-image"><img alt="male" src="{{asset('plugins/images/users/hanna.jpg')}}"></div>
                        <div class="chat-body">
                            <div class="chat-text">
                    ...
                    <!-- <div class="search_form">
                        <form action="">
                            ...
                            <div class="add_sticker_btn">
                                <a class="btn btn_blue" href="{{ url('add_sticker') }}">Add Sticker</a>
                            </div>
                        </form>
                    </div> -->
                </div>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xs-12">
                <div class="inner_section_heading_wrapper">
                    ...
                    <div class="btn_sec">
                        <a class="btn btn_primary" href="{{route('email_logs')}}">View All</a>
                    </div>
                </div>
            </div>
            <div class="col-md-12 col-lg-12 col-xs-12">
                <div class="inner_section_table">
                    <div class="table-responsive">
                        <table class="table table-fixed sticker_table">
                            ...
                            <tbody>
                               {{-- @foreach($result['Events'] as $key => $item)
                                <tr>
                                    <td>{{ @$item['Message']['Headers']['To'][0][0]??'N/A' }}</td>
                                    <td>{{ \Carbon\Carbon::createFromTimestamp(@$item['LoggedAt'])->format('d-m-Y h:i:s')}}</td>
                                    <td>{{@$item['Event']}}</td>
                                    <td>{{ @$item['Message']['Headers']['To'][0][1]??'N/A' }}</td>
                                    <td>{{@$item['Reason']}}</td>
                                </tr>
                                @endforeach--}}
