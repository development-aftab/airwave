            ...
            <div class="white-box">
                ...
                <div class="task-widget t-a-c">
                    ...
                    <div class="task-assign font-16">
                        ...
                        <ul class="list-inline">
                            <li class="p-l-0">
                                <img src="<?php echo e(asset('plugins/images/users/1.png')); ?>" alt="user" data-toggle="tooltip"
                                    data-placement="top" title="" data-original-title="Steave">
                            </li>
                            <li>
                                <img src="<?php echo e(asset('plugins/images/users/2.png')); ?>" alt="user" data-toggle="tooltip"
                                    data-placement="top" title="" data-original-title="Steave">
                            </li>
                            <li>
                                <img src="<?php echo e(asset('plugins/images/users/3.png')); ?>" alt="user" data-toggle="tooltip"
                                    data-placement="top" title="" data-original-title="Steave">
                            </li>
                            <li class="p-r-0">
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="white-box bg-danger color-box">
                ...
                <div class="chart">
                    <input class="knob" data-min="0" data-max="100" data-bgColor="#f86b4a" data-fgColor="#ffffff"
                        data-displayInput=false data-width="96" data-height="96" data-thickness=".1" value="25"
                        readonly>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="white-box chat-widget">
                ...
                <ul class="chat-list slimscroll" style="overflow: hidden;" tabindex="5005">
                    <li>
                        <div class="chat-image"><img alt="male" src="<?php echo e(asset('plugins/images/users/hanna.jpg')); ?>"></div>
                        <div class="chat-body">
                            <div class="chat-text">
                    ...
                    <!-- <div class="search_form">
                        <form action="">
                            ...
                            <div class="search_btn">
                                <input class="btn btn_blue" type="submit" value="Search">
                            </div>
                            ...
                            <div class="add_sticker_btn">
                                <a class="btn btn_blue" href="<?php echo e(url('add_sticker')); ?>">Add Sticker</a>
                            </div>
                        </form>
                    </div> -->
                </div>
...
<section class="dash_main_info">
    <div class="container-fluid">
        <div class="row m-0">
            <div class="col-md-12">
                <div class="inner_section_dash_info">
                    <div class="info-box">
                        <div class="media">
                            <div class="media-body">
                                <p class="info-text font-12">Email Sent</p>
                                <h3 class="info-count">50</h3>
                            </div>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="media colored">
                            <div class="media-body">
                                <p class="info-text font-12">Email Delivered</p>
                                <h3 class="info-count">30</h3>
                            </div>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="media">
                            <div class="media-body">
                                <p class="info-text font-12">Email Read</p>
                                <h3 class="info-count">18</h3>
                            </div>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="media colored">
                            <div class="media-body">
                                <p class="info-text font-12">Clicks</p>
                                <h3 class="info-count">25</h3>
                            </div>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="media">
                            <div class="media-body">
                                <p class="info-text font-12">Unread Email</p>
                                <h3 class="info-count">25</h3>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xs-12">
                <div class="inner_section_heading_wrapper">
                    ...
                    <div class="btn_sec">
                        <a class="btn btn_primary" href="<?php echo e(route('email_logs')); ?>">View All</a>
                    </div>
                </div>
            </div>
            <div class="col-md-12 col-lg-12 col-xs-12">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/backendpro/public_html/shoaib/airwave/resources/views/dashboard/index.blade.php ENDPATH**/ ?>