    ...
    <div class="navbar-header">
        ...
        <div class="top-left-part">
            <a class="logo" href="<?php echo e(url('/')); ?>">
                <b>
                    <img src="<?php echo e(asset('')); ?><?php echo e(App\CommonSetting::first()->dashboard_logo??''); ?>" alt="home"
                        style="height: 30px" />
                </b>
                <span>
                    <img src="<?php echo e(asset('')); ?><?php echo e(App\CommonSetting::first()->dashboard_logo_text??''); ?>" alt="homepage"
                        class="dark-logo" style="height: 50px;width: 73px" />
                </span>
            </a>
        </div>
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
            <li class="dropdown">
                <a class="dropdown-toggle waves-effect waves-light font-20" data-toggle="dropdown"
                    ...
                    <img src="<?php echo e(asset('website')); ?>/images/notification_icon.png" alt="">
            ...
            <li>
                <div class="user_img_name_wrapper">
                    <div class="user_name">
                    ...
                    <div class="user_image">
                        ...
                        <?php else: ?>
                        <img src="<?php echo e(asset('storage/uploads/users/'.auth()->user()->profile->pic)); ?>" alt="user-img"
                            class="img-circle">
                        <?php endif; ?>
                    </div>
                </div>
...
</nav><?php /**PATH /home1/backendpro/public_html/shoaib/airwave/resources/views/layouts/partials/navbar.blade.php ENDPATH**/ ?>