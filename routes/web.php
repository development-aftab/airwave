...
Route::get('email-test', function(){
    $details['email'] = 'sk@tafsol.com';


    dispatch(new App\Jobs\OrderEmail($details));


    dd('done');
});

Route::get('inbox_cron','WebsiteController@inboxCron')->name('inbox.cron');
Route::post('webhook','WebsiteController@webhook')->name('get.webhook');
...
Route::post('AddUser', 'DemoController@AddUser')->name('add.user');
...
Route::group(['middleware' => ['auth', 'roles'],'roles' => ['admin','user']], function () {
    ...
    // Custon routes starts from here
    Route::get('manage_users','WebsiteController@manageUsers')->name('manage_users');
    Route::get('groups','WebsiteController@groups')->name('groups');
    Route::get('add_groups','WebsiteController@addGroups')->name('add_groups');
    Route::get('edit_groups','WebsiteController@editGroups')->name('edit_groups');
    Route::get('mail_inbox','WebsiteController@mailInbox')->name('mail_inbox');
    Route::get('mail_sent','WebsiteController@mailSent')->name('mail_sent');
    Route::get('view_email','WebsiteController@viewEmail')->name('view_email');
    Route::get('all_campaigns','WebsiteController@allCampaigns')->name('all_campaigns');
    Route::get('send_campaigns/{id?}','WebsiteController@sendCampaigns')->name('send_campaign');
    Route::post('post_campaign','WebsiteController@postCampaign')->name('post_campaign');
    Route::get('send_email','WebsiteController@sendEmail')->name('send_email');
    Route::get('create_campaign','WebsiteController@createCampaign')->name('create_campaign');
    Route::get('edit_campaign','WebsiteController@editCampaign')->name('edit_campaign');
    Route::get('send_campaign','WebsiteController@sendCampaign')->name('send_campaign');
    Route::get('campaign_logs','WebsiteController@campaignLogs')->name('campaign_logs');
    Route::get('view_campaign_logs','WebsiteController@viewCampaignLogs')->name('view_campaign_logs');
    Route::get('email_logs','WebsiteController@emailLogs')->name('email_logs');
...
Route::resource('emailUser/email-user', 'EmailUser\\EmailUserController');
Route::resource('group/group', 'Group\\GroupController');
Route::post('singleGroupEmail','Group\\GroupController@singleGroupEmail');
Route::resource('campaign/campaign', 'Campaign\\CampaignController');
Route::resource('inbox/inbox', 'Inbox\\InboxController');
Route::resource('sentEmail/sent-email', 'SentEmail\\SentEmailController');
Route::get('/get-email-options', 'SentEmail\\SentEmailController@getEmailOptions');
Route::resource('sentGroupEmail/sent-group-email', 'SentGroupEmail\\SentGroupEmailController');